...
define('DEV_COMPANY_NAME', 'Rafael Jongco');
define('DEV_COMPANY_EMAIL', 'rj.inovino@gmail.com');
define('DEV_COMPANY_PHONE', '+639214719232');
define('DEV_COMPANY_SUPPORT_EMAIL', 'rj.inovino@gmail.com');
define('DEV_COMPANY_URL', 'https://rafaeljongco.dev.com');
define('DEV_COMPANY_LOGO', 'assets/img/logo.png');

/**
 * Product related information
 */
define('PRODUCT_NAME', 'ASSIST POINT HELPDESK');
